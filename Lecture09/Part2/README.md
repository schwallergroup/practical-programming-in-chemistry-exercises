...
Please refer to the main [README](../README.md) for preliminary instructions. Then, the exercise for Part 2 can be followed in the main notebook [from_script_to_package.ipynb](from_script_to_package.ipynb). You will be creating your package in the [amremover](amremover) directory. 
