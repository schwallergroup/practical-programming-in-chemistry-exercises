...
## Using agents: there's no replacement for critical thinking!

Even since last year when these exercises were written, LLM coding agents has become
more and more useful and powerful. Now more than ever, it is important to be critical of
the code you write (or get written for you), read, and use. Learning the fundamentals of
coding and best practices for software engineering is still important: even if your
workflow uses AI agents to do some heavy lifting, it pays off to be able to critically
analyse and understand what is going on internally in the code. In this course, you will
be manually coding to help you to learn. Invest the time to really become familiar with
the core concepts. Expect to be tested and challenged on your understanding, not just
your output, and always be critical - this is at the center of good science!